...
REM Windows: %LOCALAPPDATA%\ygs\logs
set "LOG_DIR=%LOCALAPPDATA%\ygs\logs"
...
if not defined NODE_EXEC (
    ...
    echo To fix: Set CHROME_MCP_NODE_PATH environment variable or run 'ygs doctor --fix' >> "%WRAPPER_LOG%"
    exit /B 1
)
